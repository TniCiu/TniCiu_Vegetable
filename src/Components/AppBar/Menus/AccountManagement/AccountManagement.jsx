...
import { fetchUserInfoAPI, updateUserAPI, checkOldPasswordAPI } from '../../../../apis';
...
function AccountManagement() {
  ...
  const rankThresholds = [
    { rank: 'Đồng', totalSpent: 0, description: 'Khởi đầu hành trình mua sắm của bạn.' },
    { rank: 'Bạc', totalSpent: 300000, description: 'Hưởng các ưu đãi đầu tiên với hạng Bạc.' },
    { rank: 'Vàng', totalSpent: 1000000, description: 'Tận hưởng quyền lợi cao cấp ở hạng Vàng.' },
    { rank: 'Bạch kim', totalSpent: 2500000, description: 'Đẳng cấp và ưu tiên với hạng Bạch kim.' },
    { rank: 'Kim cương', totalSpent: 5000000, description: 'Trải nghiệm đỉnh cao tại hạng Kim cương.' },
  ];
  ...
  const handleUpdateUser = async () => {
    ...
    if (password) {
      const isOldPasswordCorrect = await checkOldPasswordAPI({ email, oldPassword });
          ...
          <Grid container spacing={3} alignItems="center">
            ...
            <Grid item xs={12} md={8}>
              ...
              <Typography variant="body2" color="text.secondary" gutterBottom>
                Hạng: <Avatar src={rankIcons[rank]} sx={{ width: 24, height: 24, mr: 1 }} />{' '}
                <b>{rank}</b>
              </Typography>
